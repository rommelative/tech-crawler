...
class MIITCrawler:
            ...
            for link in all_links:
                try:
                    ...
                    if (title and len(title) > 10 and 
                        ('.html' in href or '/jgsdw' in href or '/gxwz' in href or '/zfwj' in href) and
                        not any(skip in href.lower() for skip in ['javascript', '#', 'login', 'register', 'about', 'contact', 'english', 'index.html'])):
    ...
    def fetch(self):
        ...
        pages = [
            ('index.html', '工信部'),
            ('jgsdw/xw/index.html', '工信部-要闻'),
            ('gxwz/xw/index.html', '工信部-工作动态'),
            ('zfwj/xw/index.html', '工信部-政策文件'),
            ('tzgg/xw/index.html', '工信部-通知公告'),
            ('xw/tpxw/index.html', '工信部-图片新闻'),
        ]
        ...
        for path, name in pages:
            ...
            print(f"工信部 {name}: 获取 {len(news)} 条")
